...
var bTopic_Health: BlogTopic = {
    ...
    "name" : "Health",
    "description" : "Health, the most important...",
...
var bTopic_Health_Psychological: BlogTopic = {
    ...
    "description" : "This health layer is inside your mind...",
...
var bTopic_Justice: BlogTopic = {
    ...
    "name" : "Justice",
    "description" : "To provide healthy communities",
...
var bTopic_Justice_HumanRights: BlogTopic = {
    ...
    "name" : "Human Rights",
    "description" : "Human Rights... a good start for Justice.",
...
var bTopic_Justice_SocialGroups: BlogTopic = {
    ...
    "name" : "Social Groups",
    "description" : "Everybody need good friends...",
...
export class BackBoneConfig {
    ...
    public currentMainTopic: BlogTopic;
    ...
    constructor(topicStructure: BlogTopic) {
        ...
        this.currentSubTopics = this.topicStructure.subtopics;
    }
